/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8dd7cf74941f429e6d1e756931169e8e)
// Runtime types generated with workerd@1.20250709.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		GITHUB_OWNER: "Saidiibrahim";
		GITHUB_REPO: "search-papers";
		APP_VERSION: "0.1.0";
		GITHUB_TOKEN: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").ResearchMCP>;
	}
}
